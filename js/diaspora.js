...
// 基于绝对url路径的链接点击后会跳出全屏, 因为绝对路径的url不能识别为当前网站内
// 判断不是为了解决全屏退出问题, 而是点击绝对路径跳转时, 触发全屏又立即退出的问题
document.onclick = function (e) {
//  console.log(e.target);
//     console.log(checkFull());
    if (!(checkTagA(e.target) || checkFull())){
        displayFullScreen();
    }
    // 继续传递事件
    return true;
...
$(function() {
    ...
    console.log("%c Github %c","background:#24272A; color:#ffffff","","https://github.com/LincoXiaoQ")
